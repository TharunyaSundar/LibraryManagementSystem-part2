...
export class LendingLibrary {
    ...
    async clear() {
        try {
            ...
            return Errors.errResult(`Failed to clear the database: ${error.message}`, "DB");
        }
    }
        ...
        try {
            ...
            if (existingBook) {
                ...
                if (existingBook.title !== book.title ||
                    ...
                    return Errors.errResult("Inconsistent book data: The existing book data does not match the provided details.", "BAD_REQ");
                }
            ...
            return Errors.errResult(`Failed to add the book to the library: ${error.message}`, "DB");
        }
    }
    ...
    async findBooks(req) {
        ...
        try {
            ...
            return Errors.okResult(sanitizedBooks);
        }
        catch (error) {
            return Errors.errResult(`Failed to retrieve books: ${error.message}`, "DB");
        }
    }
    ...
    async checkoutBook(req) {
        ...
        try {
            ...
            if (!book) {
                return Errors.errResult("The book does not exist in the library", "BAD_REQ");
            }
            ...
            if (existingLoan) {
                return Errors.errResult("The patron already has this book checked out", "BAD_REQ");
            }
            ...
            return Errors.errResult(`Failed to check out the book: ${error.message}`, "DB");
        }
    }
    ...
    async returnBook(req) {
        ...
        try {
            ...
            if (!loan) {
                return Errors.errResult("The patron does not have this book checked out", "BAD_REQ");
            }
